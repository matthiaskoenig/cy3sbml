...
public class AnnotationUtil {
	    ...
	    if (sbase.isSetAnnotation()){
	    	...
	    	for (CVTerm cvterm :annotation.getListOfCVTerms()){
	    		...
	    		for (String resource : cvterm.getResources()){
	    			...
	    			// TODO: qualifier multiplicity not handled, i.e. can be IS and VERSION_OF, ...
	    			// to same collection
	...
	/**
	 * Split the information in url, resource, id. Examples are:
	 * <rdf:li rdf:resource="http://identifiers.org/chebi/CHEBI:17234"/> <rdf:li
	 * rdf:resource="http://identifiers.org/kegg.compound/C00293"/>
